...
os.environ["REPLICATE_API_TOKEN"] = "r8_Fz9hzlCII6w406EbeJgQdfSD56Ma2W74HbqyF"
app = Flask(__name__)
...
def index():
    if request.method == "POST":
        ...
        headers = {'Authorization': 'Token r8_Fz9hzlCII6w406EbeJgQdfSD56Ma2W74HbqyF','Content-Type': 'application/json'}
